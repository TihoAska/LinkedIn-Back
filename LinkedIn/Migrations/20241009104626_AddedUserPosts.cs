...
{
    /// <inheritdoc />
    public partial class AddedUserPosts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostImage = table.Column<string>(type: "text", nullable: false),
                    PosterId = table.Column<int>(type: "integer", nullable: false),
                    NumberOfReactions = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostId = table.Column<int>(type: "integer", nullable: false),
                    TimeReacted = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostReactions_ReactionTypes_TypeId",
                        column: x => x.TypeId,
