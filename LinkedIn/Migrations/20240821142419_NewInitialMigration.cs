        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SchoolImageUrl = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostImpressions = table.Column<int>(type: "integer", nullable: false),
                    SearchAppearances = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyLocationId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Experiences_CompanyLocations_CompanyLocationId",
                        column: x => x.CompanyLocationId,
                        principalTable: "CompanyLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Experiences_Pages_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationImageUrl = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LicensesAndCertifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LicensesAndCertifications_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PagesFollowingId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PageUser", x => new { x.FollowersId, x.PagesFollowingId });
                    table.ForeignKey(
                        name: "FK_PageUser_FollowersId",
                        column: x => x.FollowersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PageUser_PagesFollowingId",
                        column: x => x.PagesFollowingId,
                        principalTable: "Pages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PendingConnections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PendingConnections_AspNetUsers_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PendingConnections_AspNetUsers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillsImageUrl = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserEducations_Institutions_InstitutionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Experiences_CompanyLocationId",
                table: "Experiences",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LicensesAndCertifications_UserId",
                table: "LicensesAndCertifications",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_PageUser_PagesFollowingId",
                table: "PageUser",
                column: "PagesFollowingId");

            migrationBuilder.CreateIndex(
                name: "IX_PendingConnections_ReceiverId",
                table: "PendingConnections",
                column: "ReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_PendingConnections_SenderId",
                table: "PendingConnections",
                column: "SenderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserEducations_InstitutionId",
